    ...
    return (
        <div className='container'>
            <div className='row p-5 mt-5 mb-5'>
                <h1 className='fs-2 text-left'> To create a ticket, select a relevant topic </h1>
                <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className='fs-4 text-left '><i class="fa fa-plus-circle " aria-hidden="true"></i> Account Opening</h4>
                    ...
                    <a href='' style={{ textDecoration: "none", lineHeight: "2.5" }}>Charge at Zerodha</a><br />
                    <a href='' style={{ textDecoration: "none", lineHeight: "2.5" }}>Zerodha IDFC FIRST Bank 3-in-1 Account</a><br />
                    <a href='' style={{ textDecoration: "none", lineHeight: "2.5" }}>Getting Start</a><br />

                </div>
                <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className='fs-4 text-left'><i class="fa fa-user" aria-hidden="true"></i> Your Zerodha Account</h4>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className='fs-4 text-left'><i class="fa fa-bar-chart" aria-hidden="true"></i> Your Zerodha Account</h4>
                    <a href='' style={{ textDecoration: "none", lineHeight: "2.5" }}>Margin,Product and Order types</a><br />
                    ...
                    <a href='' style={{ textDecoration: "none", lineHeight: "2.5" }}>Corporatte Actions</a><br />
                    ...
                    <a href='' style={{ textDecoration: "none", lineHeight: "2.5" }}>Pi and other platefrom</a><br />
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className='fs-4 text-left'><i class="fa fa-credit-card" aria-hidden="true"></i> Funds </h4>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className='fs-4 text-left'><i class="fa fa-circle-o-notch" aria-hidden="true"></i> Console </h4>
                    ...
                    <a href='' style={{ textDecoration: "none", lineHeight: "2.5" }}>Reeferral Program</a><br />
                    
                </div>
                <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className='fs-4 text-left'><i class="fa fa-circle-o" aria-hidden="true"></i> Coin </h4>
                    ...
                    <a href='' style={{ textDecoration: "none", lineHeight: "2.5" }}>Movingn to Coin</a><br />
